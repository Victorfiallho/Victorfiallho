...
WhatsApp AI agent for a remote secretarial company. End-to-end: architecture, deploy, debugging in production.

- **Stack:** N8N · Evolution API · Supabase · Groq (Llama 3.3 70B) · Oracle Cloud Free Tier
- **Solved:** `remoteJid` / `@lid` routing bugs, RLS policy issues, zero-cost LLM pipeline
- **Status:** Live ✅
...
- **Features:** Order lifecycle management, warehouse separation flow, shipment tracking, report generation, photo uploads, multi-role auth (admin/operator)
...
<div align="center">
<sub>Building in public · Brasília, Brazil · Open to clients and co-builders</sub>
</div>